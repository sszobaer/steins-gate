...
export const metadata: Metadata = {
  ...
  description: "Tournament wins and milestones earned by Steins Gate.",
};

const achievements = [
  { year: "2022", title: "BGIS Finalist", prize: "৳10,0000", icon: Trophy, place: "" },
  { year: "2022", title: "BDSL Monthly Battle Mania", prize: "৳20,000", icon: Trophy, place: "" },
  { year: "2022", title: "PUBG Mobile Entity Championship Finalist", prize: "$5,000", icon: Medal, place: "" },
